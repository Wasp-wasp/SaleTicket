...
namespace SaleTicket
{
    ...
    {
        private const string Letters = "2346789ABCDEFGHIJKLMNPQRSTUVWXYZ";
                ...
                void AjustRippleEffect()
                {
                    ...
                    for (int x = 0; x < nWidth; x++)
                    {
                        for (int y = 0; y < nHeight; y++)
                        {
                            ...
                            var yo = nWave * Math.Sin(2.0 * 3.1415 * x / 128.0);
                    ...
                    BitmapData bmSrc = bSrc.LockBits(new Rectangle(0, 0, baseMap.Width, baseMap.Height),
                        ImageLockMode.ReadWrite, PixelFormat.Format24bppRgb);
